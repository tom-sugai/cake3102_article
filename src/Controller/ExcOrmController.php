...
class ExcOrmController extends AppController{
    ...
    public function initialize()
    {
        ...
        //$this->Auth->allow(['collectionObj','hashUtility','introDb','queryBuilder','dataKeep','conn']);
        //基盤となるデータ
        $this->sampleHashList =[
    ...
    public function index() {
        ...
        //$this->set('msg', 'Welcome to CakePHP 3.10.2 Application.');
        $msg = 'Welcome to CakePHP 3.10.2 Application.';
        echo $msg;
    }
    ...
    public function arrayTest() {
        ...
        echo "array_map()" ."<br/>" ;
        $arr_b = array_map(function($arr_menber){
            return $arr_menber * 2;
        },$arr_a );
        print_r($arr_b);
        echo "<br/>";
        ...
        $arr_c= array_filter($arr_a, function($val){
            return $val != 2;
        });
        print_r($arr_c);
        echo "<br/>";
    ...
    public function hashUtility() {
        ...
        $test_1 = Hash::get($data, '0.friend');
        $test_2 = Hash::get($data, '1.friend');
        $test_3 = Hash::get($data, '2.friend');       
        //debug($test_1);
        //debug($test_2);
        //debug($test_3);
        */ 
        ...
        $test_4 = Hash::extract($data, '{n}.id');
        $test_5 = Hash::extract($data, '{n}.name');
        ...
        */
        ...
        //debug($result);
        //$result = Hash::insert($data, '0.dislike', 'yuki');
        //debug($result);
        ...
        //Hash::remove()
        //debug($data);
        //$result = Hash::remove($data, '{n}[id=2]');
        //debug($result);
