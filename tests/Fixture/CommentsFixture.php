...
class CommentsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'comments_ibfk_1' => ['type' => 'foreign', 'columns' => ['article_id'], 'references' => ['articles', 'id'], 'update' => 'restrict', 'delete' => 'restrict', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'published' => 1,
                'created' => '2022-04-21 01:28:20',
                'modified' => '2022-04-21 01:28:20',
            ],
        ];
        parent::init();
    }
